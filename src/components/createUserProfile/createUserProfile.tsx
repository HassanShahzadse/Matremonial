                ...
                <div className="card-body">
                  ...
                  <div className="form-group mb-3">
                    ...
                    <Field
                      ...
                      className="w-full border border-gray-300 rounded-25 p-2"
                      placeholder="Enter Willing To Relocate"
                      onChange={(e: any) => {
                  ...
                  <div className="form-group mb-3">
                    ...
                    <RadioButtons
                      ...
                      onOptionChange={(value: any) =>
                        handleFormChange("likeHaveChildren", value)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleFormChange("livingArrangements", e.target.value)
                      }
                    >
              ...
              <div className="card bg-white p-6 rounded-25 shadow-custom-dark mx-auto">
                ...
                <div className="card-body">
                  ...
                  <div className="form-group mb-3">
                    ...
                    <textarea
                      name="anyDisabilitites"
                      className="w-full border border-gray-300 rounded-25 p-2"
                      placeholder="Enter Any Disabilitites"
                      rows={5}
                      onChange={(e: any) => {
                ...
                <div className="card-body">
                  ...
                  <div className="form-group mb-3">
                    ...
                    <RadioButtons
                      ...
                      onOptionChange={(value: any) =>
                        handleFormChange("wearHijab", value)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <RadioButtons
                      ...
                      onOptionChange={(value: any) =>
                        handleFormChange("preferBeard", value)
                      }
                    />
                  </div>
                  <div className="form-group mb-3">
                    ...
                    <RadioButtons
                      ...
                      onOptionChange={(value: any) =>
                        handleFormChange("performSalaah", value)
                      }
                    />
                  </div>
                  <div className="form-group mb-3">
                    ...
                    <RadioButtons
                      ...
                      onOptionChange={(value: any) =>
                        handleFormChange("payZakat", value)
                      }
                    />
                  </div>
                  <div className="form-group mb-3">
                    <label className="mb-2">
                      Do you fast in Month of Ramadan?
                    </label>
                    <RadioButtons
                      options={radioFastRamadanOptions}
                      selectedOption={formValues.fastRamadan}
                      onOptionChange={(value: any) =>
                        handleFormChange("fastRamadan", value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="card-body">
                  ...
                  <div className="form-group mb-3">
                    ...
                    <Field
                      ...
                      className="w-full border border-gray-300 rounded-25 p-2"
                      placeholder="Enter Partner Education"
                      onChange={(e: any) => {
                  ...
                  <div className="form-group mb-3">
                    ...
                    <Field
                      ...
                      className="w-full border border-gray-300 rounded-25 p-2"
                      placeholder="Enter Partner Profession"
                      onChange={(e: any) => {
