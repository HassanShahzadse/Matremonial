  ...
  return (
    <>
      ...
      <div className="mx-auto relative ">
        ...
        <div className="flex pt-10 pb-10  lg:pt-0 lg:pb-0   lg:flex-row   flex-col  pe-16 ps-16  lg:justify-between  items-center justify-center lg:mt-[1.2rem] xl:mt-[5.75rem]    mt-12  bg-[#ED147D] ">
          <Image
