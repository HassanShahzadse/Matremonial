    ...
    <>
      ...
      <div className="mx-auto relative ">
        ...
        <div className="bg-[#fff] text-center md:pt-20 lg:pb-[5rem]  pt-[2rem] pb-[2rem]">
          <h1 className="text-[#1F2F49]  text-5xl font-semibold  ">The No.1 Trusted Dating Site</h1>
          <div className="grid lg:grid-cols-4   md:grid-cols-2 grid-cols-1    ">
            {datingSiteFeatures.map((feature, index) => (
              <div key={index} className=" mt-14">
                <h2 className="text-[#1F2F49] font-semibold">{feature.title}</h2>
                <p className="mt-3 lg:ps-10 lg:pe-10 text-[#676770]">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
     ...
     <div className="mx-auto relative">
          <div className="md:grid-cols-6  grid-cols-1">
          <Image
