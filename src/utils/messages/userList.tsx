  ...
  return (
    <>
      <div className="lg:w-1/3 xsm:w-full">
        ...
        <div className="h-[80vh] p-4 bg-white  overflow-y-scroll">
          {data.map((card) => (
            <div
              key={card.id}
              className="overflow-y-auto  active:bg-green-200 bg-white  border-b-2 shadow-md p-5"
            >
              <div className="flex space-x-6">
                ...
                <div>
                  ...
                  <div className="flex divide-x-2 divide-black mt-3">
