...
//   const dispatch = useDispatch()
  ...
  const handleFilter = (e: any) => {
    ...
    const searchFilterFunction = (contact: any) => contact.fullName.toLowerCase().includes(e.target.value.toLowerCase())
    const filteredChatsArr: any = chats.filter(searchFilterFunction)
